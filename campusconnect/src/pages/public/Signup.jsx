  ...
  return (
    <>
      <div className="text-center mb-4">
        ...
        <p style={{ color: 'var(--text-secondary)' }}>Choose your registration portal to begin</p>
      </div>

      <Row className="g-3">
        <Col xs={12}>
          <Link to="/signup/student" className="text-decoration-none">
            <Card className="hover-lift border-0 shadow-sm" style={{ cursor: 'pointer', background: 'var(--card-bg)' }}>
              <Card.Body className="d-flex align-items-center p-4">
                ...
                <div>
                  <h5 className="fw-bold mb-1" style={{ color: 'var(--text-primary)' }}>Student Registration</h5>
                  <p className="text-muted mb-0 small">Requires MTU student email (@mtu.edu.ng)</p>
                </div>
              </Card.Body>
            </Card>
          </Link>
        ...
        <Col xs={12}>
          <Link to="/signup/campus" className="text-decoration-none">
            <Card className="hover-lift border-0 shadow-sm" style={{ cursor: 'pointer', background: 'var(--card-bg)' }}>
              <Card.Body className="d-flex align-items-center p-4">
                ...
                <div>
                  <h5 className="fw-bold mb-1" style={{ color: 'var(--text-primary)' }}>Campus Registration</h5>
                  <p className="text-muted mb-0 small">Staff, campus entrepreneurs, and organizations</p>
                </div>
              </Card.Body>
            </Card>
          </Link>
